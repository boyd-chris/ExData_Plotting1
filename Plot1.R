...
# for this exercise 'course4' under working directory is used
...
# Generate Histogram for Plot 1 and copy to plot1.png
hist(two_days[,3], col = "red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power")
dev.copy(png, file = "course4/plot1.png", height = 480, width = 480)
dev.off()
